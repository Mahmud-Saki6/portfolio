        ...
        <div className="absolute inset-0 flex items-center justify-center bg-palette-bg/75 opacity-0 backdrop-blur-[2px] transition duration-300 group-hover:opacity-100">
          <div className="flex gap-4">
            <a
              ...
              className="flex h-12 w-12 items-center justify-center rounded-full border border-palette-neon/50 bg-palette-surface/95 text-palette-neon shadow-glow-neon transition hover:border-palette-purple hover:bg-palette-purple/25 hover:text-white hover:shadow-glow-purple"
