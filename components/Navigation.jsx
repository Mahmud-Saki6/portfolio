...
export default function Navigation() {
  ...
  return (
    <nav
      className={`fixed inset-x-0 top-0 z-[1000] transition-all duration-500 ${scrolled
    ...
    >
      <div className="mx-auto flex w-[92%] max-w-6xl items-center justify-between py-3">
        ...
        {/* Navigation Links */}
        <div
          className={`fixed inset-0 z-[999] flex flex-col items-center justify-center gap-6 bg-palette-bg/60 backdrop-blur-2xl transition-all duration-300 md:static md:inset-auto md:z-auto md:flex md:flex-row md:gap-5 md:bg-transparent md:backdrop-blur-none ${menuOpen ? "flex" : "hidden md:flex"
            }`}
        >
